...
//      .setJars(StreamingContext.jarOfClass(this.getClass))
      //add the line below to resolve java.lang.ClassNotFoundException: com.stream.reasoning.BodyComfortProcessing
