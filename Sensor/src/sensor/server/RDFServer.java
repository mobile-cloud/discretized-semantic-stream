...
public class RDFServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // String[] rooms = { "livingroom", "bedroom",
        // "studyroom","kitchen","bathroom"};
        String[] dataTypes = { "temp", "humidity", "volume", "illumination",
                "HCHO", "benzene", "NH3", "TVOC", "CO2", "PM10", "PM2p5", "O3",
                "CO", "SO2", "NO2" }; // 15

        SensorFactory.addAllRoom(allroomList);
        SensorFactory.addAllDataType(dataTypes);
        final ArrayList<DataItem> dl = SensorFactory
                .generateSensorDataItemList();
        ...
        while (true) {
            System.out
                    .println("Server is waiting for connection from Spark input stream...");
             ...
             * �̳߳أ�ÿ����������RDF����һ���߳���� ExecutorService pool =
             * Executors.newFixedThreadPool(80); for (DataItem di : dl) {
